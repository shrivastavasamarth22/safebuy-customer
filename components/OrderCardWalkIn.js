...
import {View, Text, Image, StyleSheet, ImageBackground, TouchableNativeFeedback, TouchableOpacity} from "react-native";
...
const OrderCardWalkIn = ({tokenNumber, timeReceived, orderNo, onPress}) => {
    return (
                ...
                <Card style={styles.cardStyle}>
                    <View style={styles.cardContainer}>
                        ...
                        <View style={{alignItems: "flex-end"}}>
                            <Text style={styles.subHeaderTextStyle}>Created On:</Text>
                            <Text style={styles.timeTextStyle}>{timeReceived}</Text>
                            <Text style={styles.subHeaderTextStyle}>Order No.</Text>
                            <Text style={styles.orderNumberTextStyle}>{orderNo}</Text>
                            <Text
                                style={[
